    ...
    if page == "🔬 New analysis":
        ...
        with st.expander("ℹ️ How do I choose Min cluster size?"):
            st.markdown(
                ...
                "rather than a one-off finding. Range: **3–20**.\n\n"
                "| Value | Effect |\n"
                "|---|---|\n"
                ...
                "| **8–10** | Fewer, tighter clusters — only clearly "
                "repeating patterns get grouped; smaller patterns are left "
                "as unclustered/one-off findings. |\n"
                "| **11–20** | Very strict — only large, obviously "
                "fleet-wide patterns form a cluster. Most findings will be "
                "left unclustered unless the workscope has very high NRC "
                "volume per aircraft. |\n\n"
